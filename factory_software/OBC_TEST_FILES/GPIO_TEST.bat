...
if %input1% GTR 12500 set ERRORLEVEL=1
...
if %input3% GTR 12500 set ERRORLEVEL=1
...
if %input5% GTR 12500 set ERRORLEVEL=1
...
if %input7% GTR 12500 set ERRORLEVEL=1
...
if %Ignition% GTR 15500 set ERRORLEVEL=1
