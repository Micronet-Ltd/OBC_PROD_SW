...
if %input2% LSS 4000 set ERRORLEVEL=1
if %input2% GTR 5000 set ERRORLEVEL=1
...
if %input4% LSS 4000 set ERRORLEVEL=1
if %input4% GTR 5000 set ERRORLEVEL=1
...
if %input6% LSS 4000 set ERRORLEVEL=1
if %input6% GTR 5000 set ERRORLEVEL=1
