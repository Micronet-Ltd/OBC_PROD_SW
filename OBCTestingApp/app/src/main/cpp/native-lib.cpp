...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_micronet_obctestingapp_GetSingleWireCanResultReceiver_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    //const char *path = env->GetStringUTFChars(path_, 0);
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_micronet_obctestingapp_GetJ1708ResultReceiver_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    //const char *path = env->GetStringUTFChars(path_, 0);
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_micronet_obctestingapp_GetRS485ResultReceiver_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    //const char *path = env->GetStringUTFChars(path_, 0);
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctestingapp_GetCanBusResultReceiver_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctestingapp_GetSingleWireCanResultReceiver_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctestingapp_GetJ1708ResultReceiver_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctestingapp_GetRS485ResultReceiver_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
