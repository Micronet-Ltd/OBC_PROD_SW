...
Java_com_micronet_obctesterboardapp_J1708Handler_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctesterboardapp_J1708Handler_close
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_micronet_obctesterboardapp_SWCHandler_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    //const char *path = env->GetStringUTFChars(path_, 0);
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctesterboardapp_SWCHandler_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_micronet_obctesterboardapp_RS485Handler_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    //const char *path = env->GetStringUTFChars(path_, 0);
...
extern "C"
JNIEXPORT void JNICALL Java_com_micronet_obctesterboardapp_RS485Handler_close
        (JNIEnv *env, jobject thiz)
{
    jclass SerialPortClass = env->GetObjectClass(thiz);
    jclass FileDescriptorClass = env->FindClass("java/io/FileDescriptor");
